...
function Footer() {
  ...
  return (
    <footer className="bg-black text-white lg:px-[66px] lg:py-[31px] p-4">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 text-sm mt-2 mb-2">
        <div>
          ...
          <p className="text-gray-400">
            Platform edukasi dan kontribusi lingkungan digital. Dibuat untuk
            Lomba Web Design Technoversary {currentYear}.
          </p>
        </div>
        ...
        <div className="lg:ml-24 md:ml-24">
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/content" className="text-white hover:text-gray-400">
                | Content
              </Link>
            </li>
            <li>
      ...
      <div className="container mx-auto mt-8 pt-4 text-left">
