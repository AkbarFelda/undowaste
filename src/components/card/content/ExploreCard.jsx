...
// import { TrashWaste, Map, Earth } from "../assets";
export { Map, TrashWaste, Earth };
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-5 mx-auto relative content-center items-center justify-center">
      {cards.map((item, index) => (
        <div
          key={index}
          className="lg:pt-12 lg:pl-8 relative bg-white rounded-[50px] shadow-md p-6 h-75 md:h-90 lg:h-150 w-3/5 lg:w-full md:w-full overflow-hidden"
        >
          <h1 className="text-2xl lg:text-4xl font-normal text-black font-primary">
            {item.title}
            <br />
            {item.subtitle}
          </h1>
