        ...
        <div className="min-h-full py-12 lg:py-10 lg:ml-12 lg:mr-16 relative">
          <div className="flex flex-col md:flex-row gap-10 items-start w-full relative z-10">
            <div className="text-center md:text-left order-2 md:order-1 w-full md:w-3/5 self-start">
              <h1 className="text-4xl sm:text-4xl sm:ml-4 lg:text-7xl font-leaguespartansemibold text-black mb-6 leading-tight">
                Gabung&nbsp;Gerakan,
                <br />
                Bersih Bersama
              </h1>

              <p className="text-black font-poppinsmedium text-lg sm:text-xl mb-10  max-w-xs mx-auto md:max-w-none md:mx-0 text-center md:text-left sm:ml-4 md:ml-4">
              ...
              <button className="bg-black text-white font-poppinsregular   rounded-full shadow-lg transition duration-300 hover:opacity-80 py-3 px-8 ml-0 sm:ml-4 md:ml-4" onClick={handleEnterWebsite}>
          ...
          <div className="py-15">
            <div className="text-center">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-leaguespartansemibold mb-12 text-black">
                Edukasi Sampah
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div>
                  ...
                  <p className="text-black font-leaguespartanregular text-sm max-w-xs mx-auto">
                ...
                <div>
                  ...
                  />
                  <h3 className="text-xl font-leaguespartansemibold text-black mb-2">
                    Proses Daur Ulang
                  </h3>
                  <p className="text-black font-leaguespartanregular text-sm max-w-xs mx-auto">
