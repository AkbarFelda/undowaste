...
function Home() {
  ...
  return (
    <>
      <div
        className="bg-center bg-no-repeat relative flex items-center"
        style={{
          backgroundImage: `url(${HomeHero})`,
          backgroundPosition: "calc(50% + 250px) top",
          backgroundSize: "70%",
        }}
      >
        <div className="relative z-10 py-12 lg:py-10 lg:ml-15 lg:mr-16 max-w-4xl">
          <h1 className="text-5xl sm:text-6xl lg:text-8xl font-semibold font-primary text-black mb-4 leading-tight">
            Undo Your              
            <br />
            Waste    
          </h1>
          <p className="text-black font-medium text-lg sm:text-xl mb-10 max-w-sm font-secondary">
      ...
      <div className="text-center items-center py-10">
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 font-secondary text-lg space-y-3">
                    <li>
                      ...
                      pemilihan sampah daur ulang, dan memanfaatkan pelestarian
                      lingkungan.
                    </li>
                    <li>
                      Menyediakan peta interaktif yang akurat dan user-friendly
                      untuk memandu menemukan fasilitas pengelolaan limbah.
                    </li>
                  </ul>
                </section>

                <section>
                  <h1 className="text-4xl font-extrabold mb-4">Our Mission</h1>
                  <ul className="list-disc pl-6 font-secondary text-lg space-y-3">
                    <li>
                      Menjadi katalisator utama dalam mewujudkan Indonesia bebas
                      sampah.
                    </li>
                    <li>
        ...
        <div className="text-black mt-16 px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[250px] max-w-[1400px] mx-auto">
            <WasteTypeCard
              icon={LeafIcon}
