    ...
    <div className="relative z-10 py-12 px-4 md:px-8 lg:px-16 gap-12 flex flex-col">
        <div className='text-center md:text-left w-full self-start flex flex-col md:flex-row items-center'>
          <div>
            ...
            <p className="text-black font-poppinsmedium text-sm md:text-lg sm:text-xl w-full md:w-4/5 mb-10 max-w-xs mx-auto md:max-w-none md:mx-0 text-center md:text-left">
        ...
        <div className="flex flex-col items-center relative md:flex-row bg-[#F6F8F9] rounded-[50px] justify-between w-full">
                ...
                <div className="flex-1 md:w-24 md:ml-20 md:mr-20 p-6">
                  <div className="mb-10">
                    <h2 className="text-2xl md:text-3xl font-leaguespartansemibold text-black">
                      Our Vision
                    </h2>
                    <p className="text-sm md:text-lg font-poppinsmedium text-black leading-relaxed mb-4">
                    ...
                    <p className="text-sm md:text-lg font-poppinsmedium text-black leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-poppinssemibold text-black mb-4">
                      Our Mission
                    </h2>
                    <p className="text-sm md:text-lg font-poppinsmedium text-black leading-relaxed">
