...
function About() {
  return (
    <div className="min-h-full py-3 lg:py-5 relative justify-center mb-20">
        ...
        <div className="flex flex-col items-center relative md:flex-row bg-[#F6F8F9] rounded-[50px] justify-between w-full">
                ...
                <div className="flex-1 md:w-24 md:ml-20 md:mr-20 p-6">
                  <div className="mb-10">
                    <h2 className="text-3xl font-semibold mb-4 font-primary text-black">
                      Our Vision
                    </h2>
                    <p className="font-secondary text-black leading-relaxed mb-4">
                  ...
                  <div>
                    <h2 className="text-3xl font-semibold text-gray-900 mb-4 font-secondary">
                      Our Mission
                    </h2>
                    <p className="font-secondary text-black leading-relaxed">
        ...
        <div className="flex flex-col gap-25 items-center w-full relative justify-center">
          <div className="flex flex-col gap-0 md:gap-30 items-center w-full relative justify-center md:flex-row md:justify-between">
            ...
            <div className='flex flex-col w-full gap-8 mt-0'>
              <h3 className='font-secondary text-black text-4xl font-semibold'>Kolaborasi</h3>
              <p className='font-secondary text-black text-xl font-medium'>
          ...
          <div className="flex flex-col gap-0 md:gap-30 items-center w-full relative justify-center md:flex-row md:justify-between">
            ...
            />
            <div className='flex flex-col w-full gap-8 mt-0'>
              <h3 className='font-secondary text-black text-4xl font-semibold'>Edukasi</h3>
              <p className='font-secondary text-black text-xl font-medium'>
          ...
          <div className="flex flex-col gap-0 md:gap-30 items-center w-full relative justify-center md:flex-row md:justify-between">
            ...
            />
            <div className='flex flex-col w-full gap-8 mt-0'>
              <h3 className='font-secondary text-black text-4xl font-semibold'>Keberlanjutan</h3>
              <p className='font-secondary text-black text-xl font-medium'>
